  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[240px] w-full gap-12 text-center">
      <div className="relative flex items-center justify-center w-20 h-20">
        ...
        {/* Middle fast wave */}
        <div className="absolute inset-0 rounded-full border-[3px] border-blue-400/30 animate-[ping_2s_ease-out_infinite_0.5s]" />

        {/* Inner solid pulsating circle with glow effect */}
        <div className="absolute inset-3 rounded-full bg-gradient-to-tr from-blue-600 to-blue-500 blur-md animate-pulse" />
        ...
        <div className="relative w-12 h-12 rounded-full bg-white shadow-[0_0_20px_rgba(59,130,246,0.5)] flex items-center justify-center border border-slate-100 z-10">
          <div className="w-5 h-5 rounded-full border-2 border-transparent border-t-blue-600 border-r-blue-500 animate-spin" />
        </div>
      </div>
