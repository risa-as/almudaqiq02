        ...
        <div className="min-h-screen bg-gray-50 p-8" dir="rtl">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="flex items-center justify-between mb-8">
                    ...
                    <button
                        onClick={() => router.back()}
                        className="flex items-center gap-2 bg-white border border-gray-200 text-gray-700 font-bold px-5 py-2.5 rounded-xl hover:bg-gray-50 hover:text-blue-600 transition-colors shadow-sm"
                    >
                        عودة
                        <ArrowRight size={18} />
                    </button>
                                    ...
                                    {supplierId && (() => {
                                        ...
                                        return (
                                            <div className="mt-2 rounded-lg border border-gray-100 bg-gray-50 divide-y divide-gray-100 text-xs">
                                                ...
                                                <div className="flex justify-between items-center px-3 py-1.5">
                                                    <span className="text-gray-500">{remaining > 0 ? 'المتبقي (دين على المورد)' : remaining < 0 ? 'زيادة مدفوعة' : 'مسدد بالكامل'}</span>
                                                    <span className={`font-bold ${remaining > 0 ? 'text-red-500' : remaining < 0 ? 'text-orange-500' : 'text-green-600'}`}>
