...
/**
 * فلتر فترة مخصصة (من → إلى) بلا مكتبة منتقي تواريخ:
 * إدخال رقمي مقنّع YYYY-MM-DD مع تحقق كامل ورسائل خطأ عربية.
 * عند التفعيل يظهر كشريحة نشطة قابلة للمسح (✕) للعودة للفترات الجاهزة.
 */
export function DateRangeFilter({ value, onChange }: DateRangeFilterProps) {
  ...
  // تعبئة الحقول من القيمة الحالية عند كل فتح
  useEffect(() => {
    if (open) {
